...
#define BIND_PROPERTY_ENUM(VAR_NAME, SET_NAME, GET_NAME, VALUES)                                   \
    ADD_PROPERTY(PropertyInfo(Variant::INT, #VAR_NAME, PROPERTY_HINT_ENUM, VALUES), #SET_NAME,     \
                 #GET_NAME)
...
template <typename F, typename... Args>
void bindStaticMethod(const StringName &className, const StringName &name, F p_function,
                      Args... args) {
...
inline bool isEditor() { return Engine::get_singleton()->is_editor_hint(); }

template <typename T> Variant::Type get_variant() { return Variant::Type::NIL; }

template <> inline Variant::Type get_variant<int>() { return Variant::Type::INT; }

template <> inline Variant::Type get_variant<float>() { return Variant::Type::FLOAT; }

template <> inline Variant::Type get_variant<bool>() { return Variant::Type::BOOL; }
